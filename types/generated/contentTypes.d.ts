...
export interface ApiHowWorkHowWork extends Struct.CollectionTypeSchema {
  collectionName: 'how_works';
  info: {
    displayName: 'how-work';
    pluralName: 'how-works';
    singularName: 'how-work';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMainSectionMainSection extends Struct.CollectionTypeSchema {
...
export interface ApiNewssNewss extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::newss.newss'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::how-work.how-work': ApiHowWorkHowWork;
