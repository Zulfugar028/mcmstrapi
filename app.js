...
const STRAPI_URL = "http://localhost:1337"; // Öz Strapi domainini yaz
const API_URL = `${STRAPI_URL}/api/sliders?populate=*`; // 'sliders' content type

let currentSlide = 0;
let slides = [];

// API-dən slayder məlumatını çəkmək
fetch(API_URL)
    .then(res => res.json())
    .then(({ data }) => {
